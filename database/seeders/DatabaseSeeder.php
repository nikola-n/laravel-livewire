...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Comment::create([
            'post_id'  => 1,
            'username' => 'Jeffrey W',
            'content'  => 'Another comment for the post with an id of 1',
        ]);
        ...
        Comment::create([
            'post_id'  => 2,
            'username' => 'Martin F',
            'content'  => 'Another comment for the post with an id of 2',
        ]);
        Comment::create(['post_id' => 3, 'username' => 'Robert F', 'content' => 'A comment for post id 3']);
        Comment::create([
            'post_id'  => 3,
            'username' => 'Jennifer D',
            'content'  => 'Another comment for the post with an id of 3',
        ]);
